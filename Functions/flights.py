...
class FlightData:
    ...
    and airports using data from various CSV files. It enables visualization
    of airport locations, analysis of flight distances, and retrieval of
    detailed information about specific aircraft models and airports.
    ...
    def airport_info(self, airport: str) -> pd.DataFrame:
        ...
        detailed information about a specified airport, including its code,
